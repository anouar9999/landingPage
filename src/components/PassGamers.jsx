  ...
  const passAdvantages = [
    {
      ...
      description: t(
        ...
        "Accès prioritaire aux tournois nationaux et événements gaming"
      ),
      backgroundImage:
        "url('https://images.unsplash.com/photo-1542751371-adc38448a05e?w=500&h=300&fit=crop&auto=format')",
    },
    {
      icon: <Gift size={24} />,
      ...
      description: t(
        ...
        "Réductions sur les produits gaming chez nos partenaires"
      ),
      backgroundImage:
        "url('https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=500&h=300&fit=crop&auto=format')",
    },
    {
      ...
      description: t(
        ...
        "Statut reconnu de joueur esport par le Ministère"
      ),
      backgroundImage:
        "url('https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=500&h=300&fit=crop&auto=format')",
    },
    {
      icon: <Trophy size={24} />,
      ...
      backgroundImage:
        "url('https://images.unsplash.com/photo-1511512578047-dfb367046420?w=500&h=300&fit=crop&auto=format')",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-8">
            ...
            <div className="space-y-4">
              <h1 className=" bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 bg-clip-text text-transparent drop-shadow-2xl">
                {language === "fr" ? (
                  <FrenchTitle textKey="passGamers.title" as="div" />
                ) : (
            ...
            {/* Subtitle */}
            <p
              className={`text-white/90 text-lg font-circular-web leading-relaxed max-w-lg mx-auto lg:mx-0 `}
            >
              ...
              <div className="mx-2 sm:mx-4">
                ...
                >
                  ...
                  <span className="relative flex items-center px-4 py-2 sm:px-6 sm:py-3 md:px-8">
                    ...
                    <span
                      className={`relative flex justify-between special-font z-10 text-sm sm:text-md md:text-xl text-black uppercase `}
                    >
                      <Sparkles
                        size={20}
            ...
            <div className="flex justify-center lg:justify-start gap-8 pt-8 border-t border-white/10">
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-400 font-zentry">
                  50K+
                </div>
                <div className="text-md text-white/60 font-circular-web">
                  Membres actifs
                </div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400 font-zentry">
                  24h
                </div>
                <div className="text-md text-white/60 font-circular-web">
                  Traitement
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-400 font-zentry">
                  100%
                </div>
                <div className="text-md text-white/60 font-circular-web">
                  Gratuit
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <div className="flex justify-start   mb-4">
                        <h4 className="text-white font-zentry tracking-wider text-lg text-right max-w-[70%]">
                          {advantage.title}
                        </h4>
                      </div>
                      ...
                      <div className="mt-auto flex justify-between items-end">
                        ...
                        <div className="max-w-[60%]  transition-opacity duration-500">
                          <p className="text-white/90 text-base font-circular-web leading-relaxed text-right">
              ...
              <div className="space-y-6">
                {steps.map((step, idx) => (
                  ...
                  >
                    <div className="relative">
                      <div
                        className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white font-bold shadow-xl transition-all duration-300 ${
