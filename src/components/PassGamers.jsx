  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-gradient-to-r from-yellow-400/15 via-orange-500/8 to-transparent blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-20 right-20 w-56 h-56 rounded-full bg-gradient-to-r from-purple-500/15 via-pink-500/8 to-transparent blur-3xl animate-bounce-slow"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 rounded-full bg-gradient-to-r from-cyan-400/15 to-blue-500/8 blur-3xl animate-spin-slow"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-4">
            ...
            <div>
                ...
                {language === "fr" ? (
                  <div className="relative">
                    <FrenchTitle 
                      ...
                      as="h1" 
                      className="special-font text-3xl sm:text-4xl md:text-4xl lg:text-4xl font-black bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 bg-clip-text text-transparent drop-shadow-2xl relative z-10"
                    />
                  ...
                  <div className="relative">
                    <h1 className="special-font text-3xl sm:text-4xl md:text-4xl lg:text-4xl font-black bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 bg-clip-text text-transparent drop-shadow-2xl relative z-10">
              ...
              {/* Subtitle */}
              <p className="text-white/90 text-xs md:text-sm font-circular-web leading-relaxed max-w-lg mx-auto lg:mx-0 mt-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start items-center mt-4">
              ...
              >
                ...
                {/* Button */}
                <div className="relative">
                  <div className="bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 px-5 py-2.5 rounded-lg transition-all duration-300 group-hover:scale-105">
                    <span className="flex items-center gap-2 special-font text-base text-black font-black uppercase tracking-wider">
                      <Sparkles
                        size={20}
                        className="group-hover:rotate-180 transition-transform duration-500"
                      />
                      {t("passGamers.ctaButton", "Join us now")}
                      <ChevronRight
                        size={20}
            ...
            {/* Enhanced Steps */}
            <div className="steps-section bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-4 border border-white/10 mt-4">
              <div className="mb-3">
                <div className="flex items-center gap-2 mb-2">
                  <Zap className="text-yellow-400" size={20} />
                  <h3 className="text-xl font-black text-white uppercase tracking-wide font-zentry">
              ...
              <div className="space-y-2">
                {steps.map((step, idx) => (
                  <div
                    key={idx}
                    className={`step-card group relative flex items-start gap-3 p-3 rounded-xl transition-all duration-500 cursor-pointer overflow-hidden ${
                      activeStep === idx
                  ...
                  >
                    ...
                    <div className="relative flex-shrink-0">
                      <div
                        className={`w-10 h-10 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center text-white shadow-xl transition-all duration-300 ${
                      ...
                      {idx < steps.length - 1 && (
                        <div className="absolute left-1/2 top-full w-1 h-3 bg-gradient-to-b from-white/30 to-transparent -translate-x-1/2"></div>
                      )}
                    </div>

                    <div className="flex-1 relative z-10">
                      <h4 className={`font-black text-base mb-0.5 font-zentry uppercase tracking-wide transition-colors ${
                        activeStep === idx ? "text-yellow-400" : "text-white group-hover:text-yellow-400"
                      }`}>
                        {step.title}
                      </h4>
                      <p className="text-white/80 text-xs font-circular-web leading-relaxed">
                        {step.description}
                      </p>
                    </div>
                    ...
                    {activeStep === idx && (
                      <div className="absolute right-3 top-1/2 -translate-y-1/2">
                        <ChevronRight className="text-yellow-400 animate-pulse" size={20} />
                      </div>
                    )}
                  </div>
                ))}
          ...
          <div className="lg:w-1/2 space-y-4">
            {/* Enhanced 3D Card - Positioned above Pass Benefits */}
            <div className="max-w-sm mx-auto lg:mx-0">
              <div 
                ref={cardRef} 
                className="group relative w-full h-48 perspective-1000 cursor-pointer"
              >
                <div className="relative w-full h-full rounded-3xl bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 shadow-2xl shadow-yellow-400/20 transform-gpu transition-all duration-500 hover:scale-105 hover:shadow-yellow-400/40 border-2 border-yellow-400/60 overflow-hidden">
                  ...
                  <div className="relative p-3 h-full flex flex-col justify-between z-10">
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="text-lg font-black text-white drop-shadow-lg font-zentry tracking-wide uppercase">
                          {t("passGamers.cardTitle", "Pass Gamius")}
                        </div>
                        <div className="text-xs text-yellow-400 font-semibold mt-1 uppercase tracking-widest">
                          {t("passGamers.cardSubtitle", "Officiel • Maroc 2025")}
                        </div>
                      </div>
                      
                      {/* Badge Icon */}
                      <div className="relative">
                        <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center shadow-2xl shadow-yellow-400/50 border-2 border-yellow-300/50 group-hover:rotate-12 transition-transform duration-300">
                          <Award size={20} className="text-black" />
                        </div>
                        <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center border-2 border-slate-900 shadow-lg">
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <div className="text-center space-y-1">
                        ...
                        <div className="px-2 py-0.5 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
                          <div className="text-xs text-white font-bold uppercase tracking-wide">
                            {t("passGamers.cardMemberStatus", "Membre Actif")}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-end">
                      <div>
                        <div className="text-xs text-white/50 mb-1 uppercase tracking-wider">{t("passGamers.cardMemberId", "ID Membre")}</div>
                      ...
                      <div className="text-right">
                        <div className="text-xs text-white/50 mb-1 uppercase tracking-wider">{t("passGamers.cardStatus", "Statut")}</div>
                        <div className="inline-flex items-center gap-1 bg-green-500/20 px-2 py-1 rounded-full border border-green-400/40 backdrop-blur-sm">
                          <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                          <span className="text-xs text-green-400 font-bold uppercase tracking-wide">{t("passGamers.cardActive", "Actif")}</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-3 advantages-section">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {passAdvantages.map((advantage, index) => (
                  <div
                    key={index}
                    className="advantage-card group relative rounded-xl p-3 transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl cursor-pointer overflow-hidden border border-white/10 hover:border-yellow-400/50 bg-gradient-to-br from-slate-800/80 via-slate-700/80 to-slate-900/80"
                  >
                    ...
                    <div className="relative z-10 flex items-start justify-between h-full">
                      ...
                      <div className="flex-1 pr-3">
                        <div className="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-gradient-to-br from-yellow-400/20 to-orange-500/20 border border-yellow-400/30 mb-1.5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                          <div className="text-yellow-400 group-hover:text-yellow-300 transition-colors">
                            {advantage.icon}
                          </div>
                        </div>
                        
                        <h4 className="text-white font-black text-sm mb-0.5 font-zentry uppercase tracking-wide group-hover:text-yellow-400 transition-colors">
                          {advantage.title}
                        </h4>
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-1 h-10 bg-gradient-to-b from-yellow-400 to-orange-500 rounded-full group-hover:h-12 transition-all duration-300"></div>
                      </div>
                    </div>
