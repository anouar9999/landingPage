...
import FloatingLabelTextArea from './FloatingTextArea';
  ...
  return (
    <div className="relative min-h-screen flex flex-col md:flex-row">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-bl from-transparent via-black/80 to-transparent"></div>
        <div
          className={`absolute inset-0 bg-gradient-to-l from-black/95 via-black to-transparent`}
        ></div>
      </div>
      ...
      >
        ...
        <div className={isLogin ? 'max-w-md w-full' : ' w-full max-w-2xl'}>
          ...
          file:rounded-full file:border-0 file:text-sm file:bg-black 
